...
if ($_POST) {
    if ($_POST['persona'] == 'persona_full') {
        ...
        $inscrito = $new_user->new_persona_full($_SESSION['rol'], $datos);
        if ($inscrito[0]) {
...
<div class="container-fluid">
    <div class="row center_div" id="holder">
        <div class="col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2" id="form-holder">
            <form id="form_persona" name="form_persona" class="form-horizontal" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                ...
                <br />
                    <h1 style="background-color: white;"><small>Ingresá tus datos personales</small></h1>
                </div>
...
<!--                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="text-center text-success"><strong>¡Felicitaciones!</strong> Ya estas registrado en nuestro sistema como usuario común</h2>
                                <div class="alert alert-warning">
                                    <div><strong>Recordá que para ingresar la próxima vez, podés hacerlo con tu DNI y la clave que configuraste.</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12"><h3 class="text-center">¿Querés responder las preguntas de inscripción ahora?</h3></div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" id="btn_no" class="btn btn-danger btn-block" data-dismiss="modal">No, respondo la próxima vez que entre</button>
                        <button type="button" id="btn_si" class="btn btn-success btn-block">Sí, quiero contestar ahora</button>
                    </div>
                </div>
            </div>
        </div>
